...
import '../widgets/profile/merchant_profile_header.dart';
import '../widgets/profile/merchant_stats_section.dart';
import '../../customer/widgets/profile/profile_menu_item.dart';
import '../../customer/widgets/profile/language_selection_dialog.dart';
import '../../customer/widgets/profile/help_support_bottom_sheet.dart';
...
class MerchantProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<MerchantProfileCubit, MerchantProfileState>(
      listener: (context, state) {
        if (state is MerchantProfileLoggedOut) {
        ...
        } else if (state is MerchantProfileUpdated) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Row(
                children: [
                ...
                return SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      ...
                      MerchantProfileHeader(profile: state.profile),
                      SizedBox(height: r.spacing(24)),
                      MerchantStatsSection(profile: state.profile),
                      SizedBox(height: r.spacing(20)),
      ...
      child: Column(
        children: [
          ProfileMenuItem(
            ...
            title: 'edit_store_profile'.tr(context),
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => BlocProvider.value(
                    ...
                    child: const EditMerchantProfileScreen(),
                  ),
                ),
              );
            },
                ...
                children: [
                  ...
                  Expanded(
                    child: ElevatedButton(
                      onPressed: () {
                        context.read<MerchantProfileCubit>().logout();
